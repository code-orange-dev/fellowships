...
- **Monthly work report** by the 5th of each month (see [template](../templates/monthly-report.md)). PRs merged, PRs raised, PRs reviewed, what's next.
- **Weekly mentor call**. Show up prepared.
- **Bi-weekly cohort sync**. Share progress with the other fellows.
- **Community participation**. Attend Code Orange sessions when possible. Help newer learners.
- **Professionalism**. You represent yourself and Code Orange in public project discussions. Be thoughtful. Be kind. Ship good code.

If you consistently miss reports or go silent, we'll talk about it. If it doesn't improve, the fellowship ends.

---

## What Success Looks Like

After 6 months, a strong developer fellow has:

- 6+ PRs merged to their target project
- A track record visible on GitHub that any grant committee can evaluate
- Relationships with project maintainers who know their work
- At least one grant application submitted for independent funding
- The skills and reputation to continue as an independent contributor

Some fellows will get grants and go full-time on FOSS. Some will join Bitcoin companies. Some will continue part-time while working other jobs. All of them will be real contributors with real proof of work.

---

## How to Apply

1. **Start contributing.** Before you apply, open at least one PR (even small) to the project you want to work on. We want to see that you can navigate a real codebase, not just talk about it.
